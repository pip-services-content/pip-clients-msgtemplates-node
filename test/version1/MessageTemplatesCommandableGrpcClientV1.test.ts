...
import { MessageTemplatesCommandableGrpcServiceV1 } from 'pip-services-msgtemplates-node';
...
suite('MessageTemplatesCommandableGrpcClientV1', ()=> {
    ...
    suiteSetup((done) => {
        ...
        let references: References = References.fromTuples(
            ...
            new Descriptor('pip-services-msgtemplates', 'service', 'commandable-grpc', 'default', '1.0'), service
        );
