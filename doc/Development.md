# Development and Testing Guide <br/> MessageTemplates Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-content/pip-clients-msgtemplates-node.git
```
