...
export interface IMessageTemplatesClientV1 {
    ...
    getTemplateByIdOrName(correlationId: string, idOrName: string, callback: (err: any, msgtemplate: MessageTemplateV1) => void): void;
