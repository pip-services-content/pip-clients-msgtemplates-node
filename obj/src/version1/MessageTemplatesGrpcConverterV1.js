...
class MessageTemplatesGrpcConverterV1 {
    ...
    static toPagingParams(obj) {
        if (obj == null)
            return null;
        let paging = new pip_services3_commons_node_2.PagingParams(obj.getSkip(), obj.getTake(), obj.getTotal());
        return paging;
    }
    ...
    static toMessageTemplate(obj) {
        ...
        let template = {
            ...
            name: obj.getName(),
            from: obj.getFrom(),
            subject: new pip_services3_commons_node_1.MultiString(),
            text: new pip_services3_commons_node_1.MultiString(),
            html: new pip_services3_commons_node_1.MultiString(),
            status: obj.getStatus()
        };
    ...
    static fromMessageTemplatePage(page) {
        ...
        let data = _.map(page.data, MessageTemplatesGrpcConverterV1.fromMessageTemplate);
    ...
    static toMessageTemplatePage(obj) {
        if (obj == null)
            return null;
        let data = _.map(obj.getDataList(), MessageTemplatesGrpcConverterV1.toMessageTemplate);
        let page = {
            total: obj.getTotal(),
            data: data
        };
